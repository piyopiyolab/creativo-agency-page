        ...
        <section id={id} className={className}>
            ...
            <div className="flex flex-col sm:flex-row ">
                ...
                <p className="font-semi-bold text-2xl sm:ml-12 mb-8 max-w-[45rem]">
                    ...
                    <a href='mailto:hello@creativo.com' className="my-8 bg-slate-200 block max-w-fit px-2 py-1 rounded-lg text-primary-color font-bold hover:bg-primary-color hover:text-slate-200 duration-200">LET'S TALK</a>
                </p>
